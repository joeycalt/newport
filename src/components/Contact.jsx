  ...
  return (
    <div name='Contact' className='w-full h-screen bg-black text-white p-4 px-10'>
        <div className='flex flex-col p4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline text-green-400'>Contact</p>
                <p className='py-3'>Submit a form below to connect</p>
            </div>
            <div className='flex justify-center items-center'>
                <form action='https://getform.io/f/acbe2159-4c3b-495c-92f5-a1d58a68549e' method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='text-black bg-green-400 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's Connect</button>
                </form>
            </div>
        </div>
    </div>
