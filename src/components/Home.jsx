    ...
    <div name='Home' className='h-screen w-full bg-gradient-to-b bg-black'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row text-white '>
            <div className='flex flex-col justify-center h-full px-5'>
                ...
                <p className='pt-10 sm:text-3xl text-xl'>Previously I was a plumber (new year, new me) but currently, I love to work on projects using technologies such as React, JavaScrpit, Tailwind, and much more.</p>
                <div>
                    <Link 
                    to='Projects'
                    smooth duration={500}
